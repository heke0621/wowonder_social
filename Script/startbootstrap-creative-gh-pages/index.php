      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="basicExampleNav">
          <ul class="navbar-nav ml-auto my-2 my-lg-0 smooth-scroll">
            <li class="nav-item"><a class="nav-link " href="https://localhost/wowonder_social/Script/">音樂作品</a></li>
            <li class="nav-item"><a class="nav-link " href="https://localhost/wowonder_social/Script/blogs">部落格</a></li>
            <li class="nav-item"><a class="nav-link " href="https://localhost/wowonder_social/Script/funding">募資</a></li>
            <li class="nav-item"><a class="nav-link " href="https://localhost/wowonder_social/Script/">登入</a></li>
          </ul>
        </div>
      </div>
    </nav>
        ...
        <div class="container-fluid d-flex align-items-center justify-content-center h-100">
          ...
          <div class="row d-flex justify-content-center text-center">
            ...
            <div class="col-md-10">
              ...
              <!-- Heading -->
              <h1 class="text-uppercase text-white font-weight-bold" style="font-size:60px;">用一首曲，譜一段故事</h1><br>
  ...
  <main>
    ...
    <div class="container">
      ...
      <section id="contact">
        ...
        <!-- Heading -->
        <h2 class="mb-5 py-5 font-weight-bold text-center">Contact us</h2>
